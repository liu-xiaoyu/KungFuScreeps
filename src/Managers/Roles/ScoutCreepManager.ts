import { ROLE_SCOUT, CreepApi, UserException, PathfindingApi, MOVEMENT_CACHE_TTL } from "utils/internals";
...
export class ScoutCreepManager implements ICivCreepRoleManager {
    ...
    public getNewTargetRoom(creep: Creep): string {
        ...
        let randomInt: number = Math.floor(Math.random() * Object.keys(exits).length);
        // Keys are 1 3 5 7, possible values of randomInt = 0 1 2 3;
        let randomDirection = ((randomInt * 2) + 1).toString() as ExitKey;
